...
cartRouter.post('/:userId/checkout', _cart.findAllItemsOnCart, _orders.saveOrder, _cart.emptyCart);
cartRouter.post('/:userId/:itemId', _cart.addItemToCart);
cartRouter["delete"]('/:userId', _cart.deleteCart);
cartRouter.put('/:userId/:itemId', _cart.findItemOnCart, _cart.updateItemOnCart);
