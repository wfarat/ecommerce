...
var Model = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(Model, [{
    ...
    key: "update",
    value: function () {
      var _update = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee4(column, value, clause) {
        var query;
        return _regenerator["default"].wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                query = "UPDATE ".concat(this.table, "\n                 SET ").concat(column, " = '").concat(value, "' \n                WHERE ").concat(clause);
    ...
    value: function () {
      var _updateWithReturn = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee5(column, value, clause) {
        var query;
    ...
    key: "delete",
    value: function () {
      var _delete2 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee6(clause) {
        var query;
        return _regenerator["default"].wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                query = "DELETE FROM ".concat(this.table, " WHERE ").concat(clause);
