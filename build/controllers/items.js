...
exports.updateItem = exports.selectItem = exports.selectAllItems = exports.findItem = exports.deleteItem = exports.addItem = void 0;
...
var findItem = /*#__PURE__*/function () {
  var _ref2 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(req, res, next, itemId) {
    var item;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            values = "'".concat(name, "', ").concat(price, ",'").concat(description, "'");
            _context3.next = 5;
    ...
    return _regenerator["default"].wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 2:
            res.status(200).send({
              message: "Item id ".concat(req.item.id, " is successfuly deleted.")
            });
    ...
    return _regenerator["default"].wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            _req$body2 = req.body, name = _req$body2.name, price = _req$body2.price, description = _req$body2.description;
