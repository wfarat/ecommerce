...
exports.selectOrdersByUser = exports.selectOrderItems = exports.saveOrder = exports.findOrder = void 0;
    ...
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return ordersModel.select('*', " WHERE user_id = ".concat(userId));
...
var findById = /*#__PURE__*/function () {
  var _ref2 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(orderId) {
    var data, order;
    ...
    return _regenerator["default"].wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return orderItemsModel.select('*', " WHERE order_id = ".concat(orderId));
...
var findOrder = /*#__PURE__*/function () {
  var _ref4 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee4(req, res, next, orderId) {
    var order;
                  ...
                  while (1) {
                    switch (_context5.prev = _context5.next) {
                      case 0:
                        ...
                        val = "".concat(order.id, ", ").concat(item.id, ", ").concat(item.qty, ", ").concat(item.price);
                        _context5.next = 4;
