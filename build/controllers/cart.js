...
exports.updateItemOnCart =
  exports.sendItem =
  exports.sendAllItems =
      ...
      return _regenerator['default'].wrap(function _callee$(_context) {
        while (1) {
          switch ((_context.prev = _context.next)) {
            case 0:
              _context.next = 2;
              return cartsModel.select(
                '*',
                ' WHERE user_id = '
                  .concat(userId, ' AND item_id = ')
                  .concat(itemId)
              );
...
var findByUser = /*#__PURE__*/ (function () {
  var _ref2 = (0, _asyncToGenerator2['default'])(
    /*#__PURE__*/ _regenerator['default'].mark(function _callee2(userId) {
      var data, items;
          ...
          switch ((_context3.prev = _context3.next)) {
            ...
            case 2:
              ...
              if (!item) {
                res.status(404).send({
                  message: 'Item id '
                    .concat(req.item.id, ' on user id ')
                    .concat(req.user.id, " doesn't exist"),
                });
              } else {
                req.item = item;
                next();
          ...
          switch ((_context7.prev = _context7.next)) {
            ...
            case 3:
              ...
              res.status(400).send({
                message: 'Item id '
                  .concat(req.item.id, ' on user id ')
                  .concat(req.user.id, ' already exists'),
              });
              _context7.next = 16;
              break;
