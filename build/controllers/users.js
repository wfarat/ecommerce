...
exports.updateUser = exports.updatePassword = exports.selectUser = exports.selectAllUsers = exports.findUser = exports.deleteUser = exports.addUser = void 0;
...
var findUser = /*#__PURE__*/function () {
  var _ref3 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3(req, res, next, userId) {
    var user;
...
var addUser = /*#__PURE__*/function () {
  var _ref5 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee6(req, res, next) {
    var _req$body, email, password, fullname, checkIfExists, columns, saltRounds;
          ...
          case 3:
            ...
            if (checkIfExists) {
              ...
              _bcrypt["default"].genSalt(saltRounds, function (err, salt) {
                _bcrypt["default"].hash(password, salt, /*#__PURE__*/function () {
                  var _ref6 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee5(err, hash) {
                    var values, user;
                    return _regenerator["default"].wrap(function _callee5$(_context5) {
                      while (1) {
                        switch (_context5.prev = _context5.next) {
                          ...
                          case 2:
                            values = "'".concat(email, "', '").concat(hash, "','").concat(fullname, "'");
                            _context5.next = 5;
                            return usersModel.insertWithReturn(columns, values);
    ...
    return _regenerator["default"].wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            _req$user = req.user, id = _req$user.id, fullname = _req$user.fullname, email = _req$user.email;
            user = {
              id: id,
              fullname: fullname,
              email: email
    ...
    return _regenerator["default"].wrap(function _callee8$(_context8) {
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            _req$body2 = req.body, email = _req$body2.email, fullname = _req$body2.fullname;
      ...
      while (1) {
        switch (_context10.prev = _context10.next) {
          case 0:
            ...
            _bcrypt["default"].compare(oldPassword, req.user.password, function (err, result) {
              if (!result) {
                res.status(400).send({
              ...
              _bcrypt["default"].genSalt(saltRounds, function (err, salt) {
                _bcrypt["default"].hash(newPassword, salt, /*#__PURE__*/function () {
                  var _ref10 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee9(err, hash) {
                      ...
                      while (1) {
                        switch (_context9.prev = _context9.next) {
                          case 0:
                            ...
                            _context9.next = 3;
                            return usersModel.update('password', hash, clause);
    ...
    return _regenerator["default"].wrap(function _callee11$(_context11) {
      while (1) {
        switch (_context11.prev = _context11.next) {
          ...
          case 2:
            res.status(200).send({
              message: "User id ".concat(req.user.id, " is successfuly deleted.")
            });
